...
data=read.csv("In_integrated_batch_3000_module_scores_predicted_final_metadata.csv",row.names=1)
colnames(data)
...
write.csv(MainFrame,file="MeanModuleScores_complex165_Inh.csv")
