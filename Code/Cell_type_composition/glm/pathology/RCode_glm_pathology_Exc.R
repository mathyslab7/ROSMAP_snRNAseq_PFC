...
cell_types_list=c("Exc.L2.3.CBLN2.LINC02306",
                  "Exc.L3.4.RORB.CUX2",
                  "Exc.L3.5.RORB.PLCH1",             
                  "Exc.L4.5.RORB.IL1RAPL2",
                  "Exc.L4.5.RORB.GABRG1",
...
for(var in cell_types_list){
  ...
  setwd("D:/Projects/Large_scale_snRNA_seq/PFC_429_final/Metadata/Metadata_from_Seurat_objects/PFC427_Exc12/glm/Exc_pathology")
  file_name=paste0("Exc_",var2,".csv")
