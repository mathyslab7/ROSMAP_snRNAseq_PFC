...
cell_types=c("projid","Exc","Inh","Ast","Oli","OPC","Mic","CAMs","T.cells","End","Per","SMC","Fib")
...
cell_types_list=c("Exc","Inh","Ast","Oli","OPC","Mic")
...
for(var in cell_types_list){
  ...
  setwd("D:/Projects/Large_scale_snRNA_seq/PFC_429_final/Metadata/Metadata_from_Seurat_objects/PFC427_Exc12/glm/MCT_cognition_part1")
  file_name=paste0("MCT_",var2,".csv")
