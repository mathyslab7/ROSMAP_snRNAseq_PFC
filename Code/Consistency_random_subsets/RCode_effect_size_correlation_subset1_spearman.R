...
write.csv(results_final_p,file="Effect_size_spearman_correlation_subset1_p.csv")
write.csv(results_final_r,file="Effect_size_spearman_correlation_subset1_r.csv")
